...
| btop | 1.4.7 | https://github.com/aristocratos/btop | btop can be used by any user now.<br> However, btop needs root <br>access or permissive <br>SElinux mode to read the<br> network statistics.<br> When started by a non-root ser with SELinux enabled, <br>btop prints "[limited]" after the IP address |
